        ...
        <div className='border-t border-slate-100 bg-slate-50/80 px-6 py-6 sm:px-8'>
          ...
          <dl className='grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2'>
            <div className='sm:col-span-1 bg-white p-4 rounded-lg shadow-sm border border-slate-100'>
              ...
              <dd className='mt-2 text-sm text-slate-900 font-medium'>
                {user?.email}
              </dd>
            </div>
            <div className='sm:col-span-1 bg-white p-4 rounded-lg shadow-sm border border-slate-100'>
              ...
              <dd className='mt-2 text-sm text-slate-900 font-semibold text-indigo-700 bg-indigo-50 inline-block px-2 py-0.5 rounded'>
                Admin
              </dd>
            </div>
            <div className='sm:col-span-2 bg-white p-4 rounded-lg shadow-sm border border-slate-100'>
              ...
              <dd className='mt-2 text-sm text-slate-600 leading-relaxed'>
                You have full access to all system options, data integrations,
                and billing management. Please ensure you log out when accessing
                from a public device.
              </dd>
            </div>
          </dl>
        </div>
